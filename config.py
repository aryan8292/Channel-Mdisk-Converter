...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "5981394413:AAElVYV--ZHtBpymH3MiGLPVUDRM8Jic1TU")
DROPLINK_API = os.environ.get("DROPLINK_API")
MDISK_API = os.environ.get("MDISK_API", "l1byxdzqYxkvia9Qodpd")
...
CHANNEL_ID = list(int(i.strip()) for i in os.environ.get("CHANNEL_ID").split("-1001673937113")) if os.environ.get("CHANNEL_ID") else []
